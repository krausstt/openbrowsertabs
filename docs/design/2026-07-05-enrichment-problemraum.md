...
| 2026-07-19 | Second-Brain-Architektur ausrecherchiert (Recommender/Knowledge-Graph/NotebookLM) → siehe `docs/design/2026-07-19-second-brain-architektur.md`; `related_ids` wird durch typisierte `entities`/`edges`-Tabellen ersetzt (schaltet Modell-Radar + Fork B AR-Graph auf demselben Schema frei) | empfohlen, Bau nicht freigegeben |
